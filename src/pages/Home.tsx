...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative h-[60vh] sm:h-[70vh] bg-gradient-to-br from-pink-100 via-purple-50 to-indigo-100 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/products"
                  className="inline-flex items-center justify-center px-6 sm:px-8 py-3 bg-gradient-to-r from-pink-600 to-purple-600 text-white font-medium rounded-xl hover:from-pink-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
                  Shop Collection
                ...
                <Link
                  to="/categories"
                  className="inline-flex items-center justify-center px-6 sm:px-8 py-3 border-2 border-gray-300 text-gray-700 font-medium rounded-xl hover:border-pink-300 hover:text-pink-600 transition-all duration-200"
                >
                  Browse Categories
                </Link>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center group">
              ...
              <p className="text-sm sm:text-base text-gray-600">Free shipping on all orders over $100. Fast and reliable delivery worldwide.</p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Quality Guarantee</h3>
              <p className="text-sm sm:text-base text-gray-600">Premium quality materials and craftsmanship in every piece we create.</p>
            </div>
            ...
            <div className="text-center group sm:col-span-2 md:col-span-1">
              ...
              <p className="text-sm sm:text-base text-gray-600">30-day hassle-free returns and exchanges. Your satisfaction is our priority.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link
              to="/products"
              className="inline-flex items-center px-6 sm:px-8 py-3 bg-gray-900 text-white font-medium rounded-xl hover:bg-gray-800 transition-colors duration-200"
            >
              View All Products
              <ArrowRight className="ml-2 w-4 h-4" />
            </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div key={index} className="bg-gray-50 rounded-2xl p-4 sm:p-6 text-center">
                <img
                ...
                <p className="text-sm sm:text-base text-gray-600 mb-4 italic">"{testimonial.comment}"</p>
